	...
	core.util.buildPage([
		...
		},
		{
			...
			content: [
				...
				[
					CT.dom.node("When your application starts up, the", "span"),
					CT.dom.pad(),
					CT.dom.link("config module", null,
						"https://github.com/bubbleboy14/cantools/blob/master/cantools/config.py",
						null, null, null, true),
					CT.dom.pad(),
					CT.dom.node("parses the", "span"),
					CT.dom.pad(),
					CT.dom.link("default server configuration", null,
						"https://github.com/bubbleboy14/cantools/blob/master/cantools/cfg.py",
						null, null, null, true),
					CT.dom.node(". Next, it pulls in each plugin's configuration, as optionally specified by a <b>cfg</b> line in the <b>init.py</b> file found in each plugin. A good example of this can be found in the", "span"),
					CT.dom.pad(),
					...
					CT.dom.link("config", null,
						...
						null, null, null, true),
					CT.dom.pad(),
					CT.dom.node("files of the", "span"),
					CT.dom.pad(),
					CT.dom.link("decide plugin", null, "/plugins.html#ctdecide"),
					CT.dom.node(". Once the defaults are all loaded, we finally apply the specific application's configuration from <b>ct.cfg</b>, which will look something like this:", "span")
				],
				CT.dom.node([
					"ENCODE = False",
					"MODE = dynamic",
