...
CT.rte = {
	...
	"wysiwygize": function(nodeid, isrestricted, val, cb, mismatchcb) {
		...
		var d = {
			...
			toolbar: 'insert | undo redo | formatselect | alignleft aligncenter alignright alignjustify | bold italic backcolor | bullist numlist outdent indent removeformat help',
		};
		if (! isrestricted) // what a bonus!
			d.toolbar = d.toolbar.replace("backcolor", "forecolor backcolor");
		tinyMCE.init(d);
